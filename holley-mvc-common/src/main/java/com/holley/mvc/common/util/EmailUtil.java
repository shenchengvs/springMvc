...
public class EmailUtil {
     ...
     * @return
     */
    public static int sendEmail(String mailServer, final String loginAccount, final String loginAuthCode, String sender, String[] recipients, String emailSubject,
                                String emailContent, String emailContentType) {
        int res = 0;
        ...
        try {
            ...
            String nick = "";
            try {
                nick = MimeUtility.encodeText("hello");
    ...
    public static void main(String[] args) throws Exception {
        int res = sendEmail("smtp.qq.com", "525423071@qq.com", "fhqsoatmxggpbijj", "525423071@qq.com", new String[] { "shenchengvs@163.com" // 这里就是一系列的收件人的邮箱了
