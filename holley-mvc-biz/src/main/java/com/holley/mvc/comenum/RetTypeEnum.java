...
public enum RetTypeEnum {
    SYS_BUSY(-1, "系统繁忙"), SUCCESS(0, "请求成功"), SIG_ERROR(4001, "签名错误"), TOKEN_ERROR(4002, "Token错误"), KEY_PARAM_ERROR(4003, "必要参数非法"), PARAM_ERROR(4004, "请求参数非法"),
    UN_PERMISSION(4005, "无权限操作"), SYS_ERROR(500, "系统错误");
